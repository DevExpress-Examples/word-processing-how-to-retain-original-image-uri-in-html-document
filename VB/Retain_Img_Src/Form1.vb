...
Namespace Retain_Img_Src
	Partial Public Class Form1
        ...
        Private Sub richEditControl1_DocumentLoaded(ByVal sender As Object, ByVal e As EventArgs) _
        Handles richEditControl1.DocumentLoaded
	...
	Public Class CustomUriProvider
        ...
        Public Function CreateImageUri(ByVal rootUri As String, ByVal image As RichEditImage, ByVal relativeUri As String) As String _
